...
# Load Francois's SNCABLING library installation:
if [ -f ${SW_DEV_BASE_DIR}/SuperNEMO/config/sncabling.bash ]; then
   source ${SW_DEV_BASE_DIR}/SuperNEMO/config/sncabling.bash
fi
